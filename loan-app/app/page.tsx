...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col p-12 bg-gradient-to-b from-slate-900 to-slate-800 justify-center">
      <div className="text-white w-full lg:w-[50%]">
        <h1 className="text-5xl md:text-6xl font-semibold leading-tight mb-6">
          <div className="mb-2">Hey Guest,</div>Welcome to <span className="gradient-text">Loanr!</span>
        </h1>
        <p className="text-xl font-normal md:text-3xl mb-6 text-slate-300">
